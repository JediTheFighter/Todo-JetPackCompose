...
import com.gd.todocompose.util.Constants.PREFERENCE_KEY
import com.gd.todocompose.util.Constants.PREFERENCE_NAME
...
class DataStoreRepository @Inject constructor(
    ...
    val readSortState: Flow<String> = dataStore.data.catch { exception ->
        ...
        val sortState = preferences[PreferenceKeys.sortKey] ?: Priority.LOW.name
        sortState
    }
}